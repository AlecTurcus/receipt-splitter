...
def test_extracted_to_receipt_valid():
    extracted = ExtractedReceipt(
        items = [
            ExtractedItem(name = "Item1", unit_price = "39.00", line_total = "39.00"),
            ExtractedItem(name = "Item2", unit_price = "0.01", line_total = "0.01")
        ],
        subtotal = "39.01",
        tax = "4.00",
        tip = "0.00",
...
def test_extracted_to_receipt_invalid():
    extracted = ExtractedReceipt(
        items = [
            ExtractedItem(name = "Item1", line_total = "39.00", unit_price = "39.00"),
            ExtractedItem(name = "Item2",  line_total = "null", unit_price="0.00")
        ],
        subtotal = "39.01",
        tax = "4.00",
        tip = "null",
